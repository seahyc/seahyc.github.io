...
- `HOME_MARKER_JSON`: normalized marker data with `heightRatio`, `side`, and
  `bayIndex`. Do not add the postal address, block number, stack number or storey
  label; the client only needs normalized geometry.
