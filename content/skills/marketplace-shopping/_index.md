...
Avoid Dynamic Island / status-bar taps (y ≲ 80–90). Use **human-like variability** (jittered taps/swipes, irregular pauses; see mobile guide) — especially on Taobao after captcha. Never enter passcodes or payment secrets.
