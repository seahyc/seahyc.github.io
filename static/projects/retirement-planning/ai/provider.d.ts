...
export declare function buildAudienceBrief(audience: "expert" | "actuary" | "doctor" | "planner" | "family", profile: ProfileRecord, plan: PlanData, result: PlanRunResult): string;
