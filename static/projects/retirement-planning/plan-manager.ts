...
export function createPlan(state: AppState, profileId: string | null): PlanData {
...
export function duplicatePlan(state: AppState, planId: string | null): PlanData | null {
...
export function deletePlan(state: AppState, planId: string | null): boolean {
