...
export const DEFAULT_DESTINATION_COSTS = {
...
const defaultCpfPlan = "escalating";
...
export const CREATE_PROFILE_NAME = (existing) => `Profile ${existing + 1}`;
export const CREATE_PLAN_NAME = (existing) => `Plan ${existing + 1}`;
export const APPENDIX_PRESETS = [
    { id: "full", label: "Full ledger" },
    { id: "cpf", label: "CPF only" },
    { id: "medical", label: "Medical only" },
    { id: "family", label: "Family & tax" },
];
export const CHART_IDS = ["incomeSpend", "assetCpf", "survivalFit", "actionImpact"];
